...
/** Returns the modal slug if the href is a modal trigger, e.g. "modal:privacy-policy" */
function modalSlug(href: string): string | null {
                      ...
                      return (
                        <li key={i}>
                          <button
                            ...
                            className="text-monks-light hover:text-white transition-colors text-sm text-left"
                          >
                            {link.name}
                          </button>
                        </li>
